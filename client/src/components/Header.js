...
function Header({ setSearchText }) {
  ...
  return (
    <nav className={`${url.pathname === "/login" || url.pathname === "/register" || url.pathname === "/password-recovery" ? "hidden" : "block"} grid grid-rows-1 grid-cols-header gap-x-4 items-center w-full py-4 px-6 sticky top-0 left-0 z-50`}>
